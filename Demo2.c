...
int main() {
	...
	//xTaskCreate(DynamicTask, "DynamicTask", 1000 , NULL , 2 ,NULL);
	//xTaskCreate(UpdateDisplay, "UpdateDisplay", 1000 , NULL ,3  ,NULL);
	//xTaskCreate(DrawTaskEx3_2_2, "DrawTaskEx3_2", 1000 , NULL ,3  ,NULL);
	//xTaskCreateStatic(StaticTask, "StaticTask", 100 , NULL , 1 ,xStack, &xTaskBuffer);
	xTaskCreate(Task3_2_3, "Task3_2_3", 1000 , NULL ,3  ,NULL);
...
int checkButtonA(){
	int state;
	state=!GPIO_ReadInputDataBit(ESPL_Register_Button_A, ESPL_Pin_Button_A);
	return state;
